...
4. Structuur (flexibel): het verloop in de ranking, wat opviel (reeksen, uitschieters), de vergelijking met het poulegemiddelde, de concurrent, groepsfase vs KO-fase / doorstoot / bonusvragen, de wereldkampioen-voorspelling (indien aanwezig in de feiten), en sluit af met één concrete tip voor een volgende poule.
